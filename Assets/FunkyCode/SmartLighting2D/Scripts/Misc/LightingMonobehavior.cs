...
namespace FunkyCode
{
	public class LightingMonoBehaviour : MonoBehaviour
	{
        ...
        public void PassLightmap(bool isSceneView, LightMainBuffer2D buffer, CameraSettings cameraSetting, CameraLightmap cameraLightmap, LightmapPreset lightmapPreset)
        {
